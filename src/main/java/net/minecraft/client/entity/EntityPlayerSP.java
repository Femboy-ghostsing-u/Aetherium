...
import dev.aetherium.client.event.update.MotionEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {	
        ...
        {
            super.onUpdate();
            Client.getEventManager().publish(new UpdateEvent());
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        {
            MotionEvent event = new MotionEvent(Prority.PRE, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.mc.thePlayer.lastReportedYaw, this.mc.thePlayer.lastReportedPitch,this.onGround);
            ...
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D, this.motionZ, event.getYaw(), event.getPitch(), event.isOnGround()));                flag2 = false;
            }
